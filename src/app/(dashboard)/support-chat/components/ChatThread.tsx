...
import { Loader2, Send, Bot, User, UserCheck, X } from 'lucide-react'
...
export function ChatThread({ conversationId, onClose }: ChatThreadProps) {
    ...
    <Card className="flex h-full flex-col">
      ...
      <div className="flex items-center justify-between border-b p-3">
        <div className="flex items-center gap-2">
          <span className="text-sm font-semibold text-gray-900">Gespräch</span>
              ...
              return (
                <div key={msg.id} className="flex gap-2 justify-end">
                  <div className="text-right">
                    ...
                    <div className="rounded-lg bg-green-50 border border-green-200 px-3 py-2 max-w-md">
                      <p className="text-sm whitespace-pre-wrap">{msg.content}</p>
                    </div>
                    <p className="text-[10px] text-gray-400 mt-0.5">
                      {new Date(msg.createdAt).toLocaleTimeString('de-DE', { hour: '2-digit', minute: '2-digit' })}
